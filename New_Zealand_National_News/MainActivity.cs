...
{
    [Activity(Label = "New_Zealand_National_News", MainLauncher = true, Icon = "@drawable/icon")]
    public class MainActivity : Activity
    {
        ...
        public async void LoadNew_Zealand_National_News()
        {
            objRest = new RESThandler(@"http://rss.nzherald.co.nz/rss/xml/nzhrsscid_000000003.xml");
